...
rem Windows build for the quadrotor PID controller. Builds the shared common\
rem modules first, then the controller-specific modules, linking ..\common\obj\*.o.
